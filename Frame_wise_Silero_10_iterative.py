...
def frames_from_labels(label_list_1,len_frame_level,frame_len,frame_level,audio_name):
...
def get_label_list(annotated_label,audio,thresh):
    ...
    #print("voiced from Labels = ",voiced_from_label)
    ...
    #print(voiced_indexes,not_speech_indexes)
